...
CARTES: list[dict] = [
...

    {
        ...
        "url_tarifs": "https://chargemap.com/fr/price",
        "methode": "httpx",
        "ideal_voyage": True,
...

    {
        ...
        "url_tarifs": "https://www.freshmile.com/nos-solutions/cartes-de-recharge/cartes-de-recharge-particuliers/",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": True,
        "flotte_pro": True,
...

    {
        ...
        "url_tarifs": "https://www.go-electra.com/fr/price/",
        "methode": "httpx",
        "ideal_voyage": True,
...

    {
        ...
        "pays_origine": ["FR", "BE"],
        "url_officielle": "https://chargeplus.totalenergies.com/fr",
        "url_tarifs": "https://chargeplus.totalenergies.com/fr/carte-de-recharge/",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": True,
        "flotte_pro": True,
    ...
    # énergie). Remplacée par Izivia, filiale EDF, qui exploite réellement un réseau.
    {
        ...
        "pays_origine": ["FR"],
        "url_officielle": "https://izivia.com/pass-de-recharge-voitures-electriques",
        "url_tarifs": "https://izivia.com/pass-de-recharge-voitures-electriques",
        "methode": "httpx",
        "ideal_voyage": False,
        "ideal_quotidien": True,
        "flotte_pro": True,
...

    {
        ...
        "url_tarifs": None,  # app-only 2026 (prix in-app uniquement)
        "methode": "manuel",
        "ideal_voyage": True,
        "ideal_quotidien": False,
        "flotte_pro": False,
...

    {
        ...
        "url_tarifs": "https://www.fastnedcharging.com/en/charging/tariffs",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": False,
        "flotte_pro": False,
...

    {
        ...
        "url_officielle": "https://www.enbw.com/elektromobilitaet/produkte/ladetarife",
        "url_tarifs": "https://www.enbw.com/elektromobilitaet/produkte/ladetarife",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": False,
        "flotte_pro": False,
...

    {
        ...
        "operateur": "Eneco",
        "pays_origine": ["BE", "NL"],
        "url_officielle": "https://www.eneco-emobility.com/be-fr",
        "url_tarifs": "https://www.eneco-emobility.com/be-fr/domicile/carte-de-recharge",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": True,
        "flotte_pro": True,
...

    {
        ...
        "pays_origine": ["BE"],
        "url_officielle": "https://blinkcharging.com/fr-be/",
        "url_tarifs": None,  # app-only depuis 27/04/2026 (prix dynamiques in-app)
        "methode": "manuel",
        "ideal_voyage": False,
        "ideal_quotidien": True,
        "flotte_pro": True,
...

    {
        ...
        "url_officielle": "https://www.allego.eu/fr",
        "url_tarifs": "https://www.allego.eu/pricing/",
        "methode": "httpx",
        "ideal_voyage": True,
        "ideal_quotidien": False,
        "flotte_pro": False,
...

    {
        ...
        "url_tarifs": "https://www.luminus.be/fr/pro/voitures-electriques/prix-aux-bornes-de-recharge-publiques-de-luminus/",
        "methode": "httpx",
        "ideal_voyage": False,
        "ideal_quotidien": True,
        "flotte_pro": False,
