...
export const ENERGY_PRICES_FALLBACK: Record<Pays, Partial<Record<string, number>>> = {
  ...
  FR: { diesel: 1.72, essence: 1.79, elec: 0.21, gnv: 1.45, h2: 13.5, efuel: 4.2 },
  BE: { diesel: 1.78, essence: 1.83, elec: 0.3, gnv: 1.55, h2: 14, efuel: 4.4 },
  CH: { diesel: 1.85, essence: 1.92, elec: 0.27, gnv: 1.85, h2: 15.5, efuel: 5 },
  CA: { diesel: 1.45, essence: 1.4, elec: 0.13, gnv: 1.25, h2: 12, efuel: 4 },
  DE: { diesel: 1.97, essence: 2.04, elec: 0.3, gnv: 1.45, h2: 12, efuel: 4.5 },
  ES: { diesel: 1.69, essence: 1.55, elec: 0.18, gnv: 1.35, h2: 11, efuel: 4 },
  IT: { diesel: 1.98, essence: 1.94, elec: 0.28, gnv: 1.4, h2: 12, efuel: 4.5 },
  NL: { diesel: 2.29, essence: 2.39, elec: 0.32, gnv: 1.55, h2: 12, efuel: 5 },
  AT: { diesel: 1.91, essence: 1.81, elec: 0.28, gnv: 1.5, h2: 12, efuel: 4.5 },
  PT: { diesel: 1.95, essence: 2.01, elec: 0.22, gnv: 1.4, h2: 12, efuel: 4.3 },
  PL: { diesel: 1.58, essence: 1.49, elec: 0.17, gnv: 1.2, h2: 11, efuel: 3.8 },
  SE: { diesel: 1.9, essence: 1.72, elec: 0.18, gnv: 1.6, h2: 13, efuel: 4.5 },
  DK: { diesel: 2.18, essence: 2.34, elec: 0.35, gnv: 1.8, h2: 14, efuel: 5 },
  IE: { diesel: 1.95, essence: 1.83, elec: 0.32, gnv: 1.6, h2: 13, efuel: 4.6 },
  FI: { diesel: 2.14, essence: 2.03, elec: 0.18, gnv: 1.7, h2: 13, efuel: 4.8 },
  LU: { diesel: 1.82, essence: 1.82, elec: 0.2, gnv: 1.45, h2: 12, efuel: 4.2 },
