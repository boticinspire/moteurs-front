...
export const PROTOCOLES: Record<TypePanne, Protocole> = {
  energie: {
    ...
    etapes: [
      ...
      { ordre: 4, texte: 'Sortez du véhicule par le côté passager (jamais côté circulation). Éloignez-vous derrière la glissière.', urgent: true },
      { ordre: 5, texte: 'Posez le triangle de signalisation à au moins 30 m derrière le véhicule (100 m sur autoroute).', urgent: false },
      { ordre: 6, texte: 'Sur autoroute : utilisez la borne SOS orange ou appelez le 15/17/112.', urgent: false },
      { ordre: 7, texte: 'NE remorquez JAMAIS un VE avec les roues motrices au sol — commandez une dépanneuse à plateau.', urgent: false, veOnly: true },
      { ordre: 8, texte: 'Pour un thermique : contactez votre assistance ou faites livrer du carburant.', urgent: false, nonVe: true },
    ],
  ...
  crevaison: {
    ...
    etapes: [
      ...
      { ordre: 3, texte: 'Sortez par le côté passager — jamais côté circulation.', urgent: true },
      { ordre: 4, texte: 'Posez le triangle de signalisation (30 m minimum, 100 m sur autoroute).', urgent: false },
      { ordre: 5, texte: 'Si vous avez une roue de secours et êtes en sécurité totale : changez le pneu. Sinon, appelez l\'assistance.', urgent: false },
      { ordre: 6, texte: 'Attention : de nombreux VE n\'ont pas de roue de secours — kit anti-crevaison ou assistance uniquement.', urgent: false, veOnly: true },
      { ordre: 7, texte: 'Serrez les boulons en étoile, vérifiez la pression avant de reprendre la route.', urgent: false, nonVe: true },
    ],
  ...
  mecanique: {
    ...
    etapes: [
      ...
      { ordre: 4, texte: 'Ne tentez pas de réparer sur autoroute — restez éloigné du trafic.', urgent: false },
      { ordre: 5, texte: 'Appelez votre assistance routière ou la borne SOS.', urgent: false },
      { ordre: 6, texte: 'Pour un VE : si voyant orange "haute tension" ou odeur chimique, éloignez-vous immédiatement et appelez les pompiers.', urgent: true, veOnly: true },
    ],
