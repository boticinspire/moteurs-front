"""
Réécrit app/[locale]/page.tsx avec useTranslations('Home') sur toutes
les chaînes FR. Écriture atomique. Conserve la logique (themes,
sessionStorage, tabs, etc.) et les classes CSS.
"""
import os
import tempfile
...
def atomic_write(target: str, content: str) -> str:
    ...
    with open(target, "rb") as f:
        data = f.read()
    return "size=" + str(size) + " nulls=" + str(b"\x00" in data) + " nl=" + str(data.count(b"\n"))
...
print(atomic_write("app/[locale]/page.tsx", PAGE_TSX))
