...
export default function AssistanceLocation() {
  ...
  if (!authUser) return (
    <div style={{ maxWidth: 520, margin: '0 auto', background: 'var(--color-bg-card)', border: '1.5px solid var(--color-border)', borderRadius: 20, overflow: 'hidden', textAlign: 'center' }}>
      <div style={{ padding: '32px 32px 24px', background: 'linear-gradient(135deg,rgba(8,145,178,0.07)0%,rgba(14,165,233,0.07)100%)', borderBottom: '1px solid var(--color-border)' }}>
        ...
        <h2 style={{ fontSize: '1.25rem', fontWeight: 800, marginBottom: 10 }}>Location & Assurance — Analyse CDW</h2>
        <p style={{ fontSize: '0.9rem', color: 'var(--color-text-muted)', lineHeight: 1.6, margin: 0 }}>Quelle assurance prendre ? Votre CB vous couvre-t-elle déjà ? Analyse personnalisée par pays et type de véhicule.</p>
      </div>
      <div style={{ padding: '24px 32px 32px' }}>
        {['12 pays analysés avec spécificités légales','Couverture CB détaillée (Visa, Mastercard, Amex…)','Recommandation CDW chiffrée avec économies','Checklists prise en charge et restitution'].map((a, i) => (
