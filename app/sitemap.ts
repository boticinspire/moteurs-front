...
const PAGES_STATIQUES: { url: string; priority: number; changeFreq: MetadataRoute.Sitemap[0]['changeFrequency'] }[] = [
  ...
  { url: '/media',         priority: 0.9,  changeFreq: 'weekly'  },
  ...
  { url: '/outils/cartes-recharge/comparatif/reseau-fastned',       priority: 0.78, changeFreq: 'weekly' },
  { url: '/outils/cartes-recharge/comparatif/reseau-ionity',        priority: 0.78, changeFreq: 'weekly' },
  { url: '/outils/cartes-recharge/comparatif/reseau-electra',       priority: 0.78, changeFreq: 'weekly' },
  { url: '/outils/cartes-recharge/comparatif/reseau-totalenergies', priority: 0.78, changeFreq: 'weekly' },
  { url: '/outils/cartes-recharge/comparatif/reseau-enbw',          priority: 0.78, changeFreq: 'weekly' },
  { url: '/outils/cartes-recharge/comparatif/reseau-allego',        priority: 0.78, changeFreq: 'weekly' },
  ...
  { url: '/outils/catalogue-electriques', priority: 0.85, changeFreq: 'weekly'  },
